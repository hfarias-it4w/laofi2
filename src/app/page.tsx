...
export default function Home() {
  ...
  const [contactPreview, setContactPreview] =
    useState<ContactPreviewData | null>(null);
  ...
  const services = useMemo(
    () => [
      ...
      },
      {
        ...
        description:
          "Ambientes profesionales con tecnología para tus encuentros clave.",
        icon: <HiMiniBuildingOffice2 className="h-6 w-6" />,
      },
      {
        title: "Cocina equipada",
        description:
          "Zonas de break con todo lo necesario para recargar energías.",
        icon: <MdKitchen className="h-6 w-6" />,
      },
      {
        title: "Servicio de limpieza",
        description:
          "Higiene diaria para que cada espacio se mantenga impecable.",
        icon: <MdOutlineCleaningServices className="h-6 w-6" />,
      },
      {
        title: "Comunidad activa",
        description:
          "Conectá con emprendedores y equipos que se potencian mutuamente.",
    ...
    () => [
      {
        ...
        quote:
          "La Ofi transformó mi forma de trabajar. El ambiente es perfecto para enfocarme y la comunidad es increíble.",
      },
      {
        initials: "AM",
        name: "Ana Martínez",
        ...
        quote:
          "Conocí personas clave para mis proyectos. El espacio inspira y el equipo siempre está cerca.",
      },
      {
        initials: "CR",
        name: "Carlos Ruiz",
        ...
        quote:
          "Encontré el equilibrio entre profesionalismo y flexibilidad. Las salas equipadas son un plus.",
      },
    ],
    [],
  );
  ...
  const updateContactField =
    (field: "name" | "email" | "company" | "message") => (value: string) => {
      ...
      <header className="sticky top-0 z-30 border-b border-neutral-200 bg-neutral-50/95 backdrop-blur">
        <div className="mx-auto flex max-w-screen-xl items-center justify-between px-6 py-4">
          ...
          <nav className="hidden items-center gap-8 text-sm font-medium text-neutral-700 md:flex">
            <a className="hover:text-neutral-900" href="#espacios">
              Espacios
            </a>
            <a className="hover:text-neutral-900" href="#servicios">
              Servicios
            </a>
            <a className="hover:text-neutral-900" href="#ubicacion">
              Ubicaciones
            </a>
            <a className="hover:text-neutral-900" href="#testimonios">
              Testimonios
            </a>
          </nav>
      ...
      <main>
        ...
        >
          ...
          <div className="relative mx-auto flex max-w-screen-xl flex-col gap-6 px-6 py-32 text-white">
            <p className="text-sm uppercase tracking-[0.2em] text-[#fdca00]">
              Coworking flexible y oficinas privadas
            </p>
            <h1
              id="hero-heading"
              className="max-w-3xl text-4xl font-black uppercase leading-tight md:text-6xl"
            >
              La oficina que crece y se adapta a tu ritmo.
            </h1>
            <p className="max-w-2xl text-lg text-neutral-200">
              Gestionamos soluciones que se adaptan a tu equipo, no al revés.
              Sumate a un espacio flexible con servicios premium y comunidad
              activa.
            </p>
        ...
        <section
          id="espacios"
          className="mx-auto max-w-screen-xl px-6 pb-16 pt-24"
        >
          <div className="text-center">
            <p className="text-sm font-semibold uppercase tracking-[0.3em] text-[#fdca00]">
              El espacio a tu medida
            </p>
            <h2 className="mt-2 text-3xl font-bold text-neutral-900 md:text-4xl">
              Tené la infraestructura que tu startup necesita
            </h2>
            <p className="mx-auto mt-4 max-w-2xl text-neutral-600">
              Infraestructura flexible lista para acompañar el ritmo de tu
              equipo. Elegí la experiencia que se alinea con tu forma de
              trabajar.
            </p>
          </div>
        ...
        <section id="servicios" className="bg-white py-24">
          <div className="mx-auto max-w-screen-xl px-6">
            <div className="text-center">
              ...
              <h2 className="mt-2 text-3xl font-bold text-neutral-900 md:text-4xl">
                Nos ocupamos del lugar, vos de tu negocio
              </h2>
              <p className="mx-auto mt-4 max-w-2xl text-neutral-600">
                Servicios pensados para que cada jornada sea más simple,
                productiva y enfocada.
              </p>
            </div>
            <div className="mt-12 grid gap-6 md:grid-cols-2 lg:grid-cols-4">
              {services.map((service) => (
                <div
                  key={service.title}
                  className="flex h-full flex-col gap-4 rounded-xl border border-neutral-200 bg-white p-6 shadow-[0_1px_2px_rgba(0,0,0,0.05)]"
                >
        ...
        <section id="ubicacion" className="mx-auto max-w-screen-xl px-6 py-24">
          <div className="text-center">
            ...
            <h2 className="mt-2 text-3xl font-bold text-neutral-900 md:text-4xl">
              Sedes estratégicas para estar en el mapa
            </h2>
            <p className="mx-auto mt-4 max-w-2xl text-neutral-600">
              Nuestra sede principal se ubica en Av. Rivadavia 14084, Ramos
              Mejía. Tres pisos pensados para equipos y profesionales.
            </p>
          </div>
          <div className="mt-12 grid gap-8 lg:grid-cols-[420px_1fr]">
            <div className="rounded-xl border border-neutral-200 bg-white p-8 text-left shadow-[0_1px_2px_rgba(0,0,0,0.05)]">
              <h3 className="text-2xl font-bold text-neutral-900">
                Rivadavia, Ramos Mejía
              </h3>
              <p className="mt-3 text-sm text-neutral-600">
                Av. Rivadavia 14084, B1704 Ramos Mejía, Buenos Aires. Tres pisos
                listos para 4 a 20 puestos, coworking flexible, salas y eventos.
              </p>
        ...
        <section className="bg-white py-20">
          <div className="mx-auto max-w-screen-xl px-6 text-center">
            ...
            <p className="mx-auto mt-4 max-w-xl text-neutral-600">
              Somos el aliado flexible de equipos innovadores. Sumate a la red
              de empresas que marcan el rumbo.
            </p>
        ...
        <section
          id="testimonios"
          className="mx-auto max-w-screen-xl px-6 py-24"
        >
          <div className="text-center">
            <p className="text-sm font-semibold uppercase tracking-[0.3em] text-[#fdca00]">
            ...
            <p className="mx-auto mt-4 max-w-2xl text-neutral-600">
              Personas y equipos que encontraron el espacio perfecto para hacer
          ...
          <div className="mt-12 grid gap-6 lg:grid-cols-3">
            {testimonials.map((testimonial) => (
              <figure
                ...
                className="flex h-full flex-col gap-6 rounded-xl border border-neutral-200 bg-white p-8 text-left shadow-[0_1px_2px_rgba(0,0,0,0.05)]"
              >
          ...
          <div className="mx-auto grid max-w-screen-xl gap-12 px-6 lg:grid-cols-[420px_1fr]">
            <div>
              ...
              <h2 className="mt-4 text-4xl font-bold leading-tight">
                Contactanos y diseñemos juntos la próxima oficina de tu equipo.
              </h2>
              <p className="mt-6 text-neutral-300">
                Descubrí cómo potenciar tu productividad en un ambiente que
                cuida cada detalle. Elegí el canal que te resulte más cómodo o
            ...
            <div className="flex flex-col gap-6 p-8">
              <div className="space-y-2">
                <p className="text-xs font-semibold uppercase tracking-[0.3em] text-neutral-500">
                  Vista previa (modo no productivo)
                </p>
                <h3 className="text-2xl font-bold text-neutral-900">
                  Se generó un email simulado
                </h3>
                <p className="text-sm text-neutral-600">
                  No se envió ningún correo real. Usá esta vista para validar el
                  contenido antes de publicar en producción.
                </p>
              </div>
              <div className="grid gap-4 rounded-2xl border border-neutral-200 bg-neutral-50 p-5 text-sm text-neutral-700">
                <div className="flex items-baseline gap-3">
                  <span className="w-20 font-semibold text-neutral-500">
                    Para
                  </span>
                  <span
                    className="truncate text-neutral-900"
                    title={contactPreview.to}
                  >
                    {contactPreview.to}
                  </span>
                </div>
      ...
      <footer className="border-t border-neutral-200 bg-neutral-50">
        <div className="mx-auto grid max-w-screen-xl gap-12 px-6 py-16 md:grid-cols-[1.2fr_1fr_1fr]">
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              ...
              <p className="text-sm font-semibold text-neutral-900">
                Espacios flexibles para equipos que crecen.
              </p>
            </div>
            <p className="text-sm text-neutral-600">
              Donde creatividad y productividad se encuentran. Sumate a una
              comunidad que impulsa nuevas ideas todos los días.
            </p>
          ...
          <div className="space-y-3">
            <h3 className="text-sm font-semibold uppercase tracking-[0.3em] text-neutral-900">
              Enlaces
            </h3>
            <nav className="flex flex-col gap-2 text-sm text-neutral-600">
              <a href="#espacios" className="hover:text-neutral-900">
                Inicio
              </a>
